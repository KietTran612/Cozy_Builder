...
1. `TownGridView` - 50 edges
2. `PrototypePlacementInputDriver` - 37 edges
3. `PrototypeTownDebug3D` - 31 edges
4. `PrototypeTownDebugView` - 28 edges
5. `PrototypeCameraInputDriver` - 24 edges
6. `Asset Pack Shortlist` - 23 edges
7. `Writing Skills` - 22 edges
8. `Development Session Log` - 21 edges
9. `Unity URP Performance Code Rules` - 19 edges
10. `com.unity.modules.jsonserialize` - 17 edges

## Surprising Connections (you probably didn't know these)
- `PrototypeTownDebugView` --references--> `GridCoord`  [EXTRACTED]
  Cozy_Builder/Assets/CozyBuilder/Runtime/Town/Debugging/PrototypeTownDebugView.cs → Town/Debugging/PrototypeTownDebugView.cs
- `PrototypeTownDebugView` --references--> `Rect`  [EXTRACTED]
  Cozy_Builder/Assets/CozyBuilder/Runtime/Town/Debugging/PrototypeTownDebugView.cs → Town/Placement/PrototypePlacementControlsView.cs
- `PrototypePlacementInputDriver` --references--> `PrototypePlacementState`  [EXTRACTED]
  Cozy_Builder/Assets/CozyBuilder/Runtime/Town/Placement/PrototypePlacementInputDriver.cs → Town/Placement/PrototypePlacementInputDriver.cs
- `TownGridView` --references--> `Dictionary`  [EXTRACTED]
...
Cohesion: 0.11
Nodes (13): Color, bool, Color, Dictionary, float, int, RuleEvaluator, TownDataStore (+5 more)

### Community 1 - "Community 1"
Cohesion: 0.13
Nodes (12): bool, CameraService, float, GridCoord, PlacementService, PrototypePlacementState, PrototypeTownDebugState, TownGridView (+4 more)

### Community 2 - "Community 2"
Cohesion: 0.14
Nodes (11): GridCoord, int, PlacementService, PrototypeTownDebugState, Rect, TownDataStore, TownVisualRebuilder, CozyBuilder.Town.Debugging (+3 more)

### Community 3 - "Community 3"
Cohesion: 0.16
Nodes (10): bool, PrototypeCameraInputDriver, CameraService, bool, CameraService, float, Vector3, IReadOnlyList (+2 more)

### Community 4 - "Community 4"
Cohesion: 0.20
Nodes (5): Dictionary, int, CozyBuilder.Town.Data, TownData, Dictionary

### Community 5 - "Community 5"
Cohesion: 0.16
Nodes (8): int, PrototypePlacementState, Rect, ICameraInputBlocker, CozyBuilder.Town.Placement, PrototypePlacementControlsView, PrototypePlacementState, Rect

### Community 6 - "Community 6"
Cohesion: 0.17
Nodes (8): RuleEvaluator, TownDataStore, TownVisualRebuilder, CozyBuilder.Town.Placement, PlacementService, RuleEvaluator, TownDataStore, TownVisualRebuilder

### Community 7 - "Community 7"
Cohesion: 0.15
Nodes (6): CameraService, CozyBuilder.Camera, float, Vector3, float, Vector3
...
Cohesion: 0.60
Nodes (3): CozyBuilder.Town.Data, Equals(), GetHashCode()

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (54): dependencies, com.cysharp.unitask, com.unity.2d.sprite, com.unity.2d.tilemap, com.unity.ads, com.unity.ai.navigation, com.unity.analytics, com.unity.collab-proxy (+46 more)
...
Cohesion: 0.06
Nodes (34): 1. Check Existing Directories, 1. Detect Project Name, 2. Check AGENTS.md, 2. Create Worktree, 3. Ask User, 3. Run Project Setup, 4. Verify Clean Baseline, 5. Report Location (+26 more)
...
Cohesion: 0.06
Nodes (31): Chiến Lược Phát Hành, Doanh Thu Chính, Doanh Thu Phụ, Giai Đoạn Trước Launch, Global Launch, Khuyến Nghị Cuối, Không Nên Bán, Kế Hoạch Triển Khai Phát Hành Và Đánh Giá Lợi Nhuận (+23 more)
...
Cohesion: 0.07
Nodes (28): Asset Pack Shortlist, Backup Test: Medieval house modular v2.0 - lite - URP, Candidate 10: Simple Buildings - Cartoon City, Candidate 11: STYLIZED Fantasy Village - Low Poly 3D Art, Candidate 12: Stylized Fantasy - Town Pack by Diminished Studios, Candidate 13: Low Poly Mini Village Free, Candidate 14: POLYGON - Town Pack - Art by Synty, Candidate 15: Pandazole - City Town Lowpoly Pack (+20 more)
...
Cohesion: 0.08
Nodes (24): 1. Observe the Symptom, 2. Find Immediate Cause, 3. Ask: What Called This?, 4. Keep Tracing Up, 5. Find Original Trigger, Adding Stack Traces, code:dot (digraph when_to_use {), code:block2 (Error: git init failed in /Users/jesse/project/packages/core) (+16 more)
...
Cohesion: 0.08
Nodes (24): code:csharp (using UnityEngine;), code:csharp (using CozyBuilder.Camera;), code:csharp (using CozyBuilder.Camera;), code:bash (git add Cozy_Builder/Assets/CozyBuilder/Runtime/Town/Placeme), code:csharp (// Thay đổi đăng ký:), code:bash (git add Cozy_Builder/Assets/CozyBuilder/Runtime/Bootstrap/Ga), code:bash (graphify update .), code:bash (git add Cozy_Builder/Assets/CozyBuilder/Runtime/Camera/ICame) (+16 more)

### Community 37 - "Community 37"
Cohesion: 0.08
Nodes (23): 3D Editing, Bước 1: Shortlist, Bước 2: Test Import, Bước 3: Style Lock, Bước 4: Procedural Compatibility, Character/Animation, Checklist License Trước Khi Ship, Công Cụ Làm Việc Đề Xuất (+15 more)

### Community 38 - "Community 38"
Cohesion: 0.09
Nodes (22): 1. Identify Independent Domains, 2. Create Task Units, 3. Execute Sequentially with Review, 4. Review and Integrate, Advantages, Antigravity Execution Model, Checkpoint Pattern, code:dot (digraph when_to_use {) (+14 more)

### Community 39 - "Community 39"
Cohesion: 0.09
Nodes (22): 1. Grid Cơ Bản, 2. Placement, 3. Color, 4. Procedural Rule Tối Thiểu, 5. Camera, 6. Debug Tooling, 7. Architecture Foundation, Chức Năng Có Trong Prototype (+14 more)

### Community 40 - "Community 40"
Cohesion: 0.09
Nodes (22): 1. Không Gian Xây Dựng Rộng Hơn, 2. Chọn Loại Grid, 3. Có Người Dân Và Sự Sống, 4. Nhiều Loại Mặt Đất Và Vật Liệu, 5. Nhiều Màu Hơn, 6. Camera Tốt Hơn, 7. Công Cụ Xây Dựng Nâng Cao, 8. Có Động Lực Nhẹ Nhưng Không Áp Lực (+14 more)
...
Cohesion: 0.10
Nodes (20): Art Và Content Pipeline, Giai Đoạn 0: Pre-Production, Giai Đoạn 1: Prototype Core, Giai Đoạn 2: Vertical Slice, Giai Đoạn 3: MVP Playable, Giai Đoạn 4: Alpha Test, Giai Đoạn 5: Beta / Store-Ready, Giai Đoạn 6: Soft Launch (+12 more)

### Community 43 - "Community 43"
Cohesion: 0.10
Nodes (20): 1. Xây Dễ, Đẹp Ngay, 2. Thư Giãn Trước Tất Cả, 3. Tự Do Nhưng Có Kiểm Soát, 4. Thị Trấn Có Sự Sống, 5. Khám Phá Và Chia Sẻ, Chức Năng Bắt Buộc Cho MVP, Chức Năng Bắt Buộc Cho Prototype Core, Core Fantasy (+12 more)

### Community 44 - "Community 44"
Cohesion: 0.29
Nodes (6): Overlapping Blocks Fix Implementation Plan, Task 1: Add Prefab Offset Configuration & Stacking Fields, Task 2: Implement Runtime Wrapper Hierarchy & Dynamic Offsets, Task 3: Adjust Renderer and Collider Adapters for Wrapper Hierarchy, Task 4: Align Debug Text Heights, Task 5: Verify Project Compiles and Graphify Synced
...
Cohesion: 0.10
Nodes (19): Checklist Code Review, Kết Luận, Mục Đích, Rule 10: Save/Load Và Undo Phải Tối Ưu Từ Đầu, Rule 11: URP Settings Cho Mobile Phải Được Khóa Sớm, Rule 12: Profiler Là Một Phần Của Workflow, Rule 13: Asset Import Phải Có Chuẩn, Rule 14: Không Thêm Feature Nếu Chưa Có Budget (+11 more)
...
Cohesion: 0.09
Nodes (21): 2026-05-21 - Code Foundation Started, 2026-05-21 - Current Status Shortcut, 2026-05-21 - Graphify Setup, 2026-05-21 - Unity MCP Local Setup, 2026-05-21 - Unity Project Setup, 2026-05-22 - Camera Assembly Decoupling & Modularization, 2026-05-22 - Dirty Cell Visual Update Loop, 2026-05-22 - First Visual Adapter Validation (+13 more)
...
Cohesion: 0.11
Nodes (17): Assessment, Code Review Agent, code:bash (git diff --stat {BASE_SHA}..{HEAD_SHA}), code:block2 (### Strengths), Critical (Must Fix), Critical Rules, Example Output, Git Range to Review (+9 more)
...
Cohesion: 0.13
Nodes (14): Context Reading Rules, Current Commit Baseline, Current Intent, Current Phase, CURRENT STATUS, Current Working Tree Notes, Graphify, Latest Code Notes (+6 more)

### Community 58 - "Community 58"
Cohesion: 0.13
Nodes (14): Asset Candidate Template, Asset Selection Checklist, Checklist License, Checklist Modularity, Checklist Performance Test, Checklist Procedural Compatibility Test, Checklist Technical, Checklist Visual Style (+6 more)
...
Cohesion: 0.17
Nodes (8): int, PlacementService, PrototypeTownDebugState, CozyBuilder.Town.Placement, PrototypePlacementDebugDriver, PlacementService, PrototypeTownDebugState, ushort

### Community 69 - "Community 69"
Cohesion: 0.14
Nodes (13): code:bash (git add Cozy_Builder/Assets/CozyBuilder/Runtime/Town/Data/Ru), code:bash (git add Cozy_Builder/Assets/CozyBuilder/Runtime/Town/Rules/R), code:bash (git add Cozy_Builder/Assets/CozyBuilder/Runtime/Town/Placeme), code:bash (git add Cozy_Builder/Assets/CozyBuilder/Runtime/Town/Debuggi), code:bash (git add Cozy_Builder/Assets/CozyBuilder/Runtime/Town/Renderi), code:bash (git commit --allow-empty -m "docs: finalize procedural rules), Kế hoạch Triển khai Hệ thống Luật Thủ tục (Procedural Rules System), Nhiệm vụ 1: Tái cấu trúc cấu trúc dữ liệu RuleResult (+5 more)
...
Cohesion: 0.15
Nodes (12): Bite-Sized Task Granularity, code:markdown (# [Feature Name] Implementation Plan), code:`markdown (### Task N: [Component Name]), code:block3, code:block4, code:block5, Execution Handoff, Overview (+4 more)

### Community 72 - "Community 72"
Cohesion: 0.15
Nodes (13): 1. VContainer, code:text (GameLifetimeScope), code:csharp (public sealed class PlacementService), code:csharp (public sealed class PlacementInputView : MonoBehaviour), Cách Tổ Chức Đề Xuất, Không Dùng VContainer Cho, Kết Luận, Nhược Điểm/Rủi Ro (+5 more)

### Community 73 - "Community 73"
Cohesion: 0.15
Nodes (12): code:csharp (public Rect PanelRect => panelRect;), code:csharp (public Rect PanelRect => panelRect;), [Component: UI & Input Routing], Kế hoạch Triển khai Định tuyến Nhập liệu và Chặn Pointer (UI/Input Routing & Pointer Blocking), Manual Verification (Unity Play Mode), [MODIFY] [PrototypeCameraInputDriver.cs](file:///d:/soflware/Unity/Source/App/Cozy_Builder/Assets/CozyBuilder/Runtime/Camera/PrototypeCameraInputDriver.cs), [MODIFY] [PrototypePlacementControlsView.cs](file:///d:/soflware/Unity/Source/App/Cozy_Builder/Assets/CozyBuilder/Runtime/Town/Placement/PrototypePlacementControlsView.cs), [MODIFY] [PrototypePlacementInputDriver.cs](file:///d:/soflware/Unity/Source/App/Cozy_Builder/Assets/CozyBuilder/Runtime/Town/Placement/PrototypePlacementInputDriver.cs) (+4 more)

### Community 74 - "Community 74"
Cohesion: 0.17
Nodes (11): code:bash (npx antigravity-superpowers init), code:bash (mkdir -p .agent), code:bash (bash .agent/tests/run-tests.sh), code:bash (bash .agent/tests/run-tests.sh), Install, Install Antigravity Superpowers Profile, Prerequisites, Update (+3 more)
...
Cohesion: 0.17
Nodes (12): Avoid assuming tools are installed, code:block52, code:block53, code:block56 (bigquery-skill/), code:markdown (Use the BigQuery:bigquery_schema tool to retrieve table sche), code:`markdown (**Bad example: Assumes installation**:), code:", Create verifiable intermediate outputs (+4 more)

### Community 78 - "Community 78"
Cohesion: 0.17
Nodes (12): 1. Rich Description Field, 2. Keyword Coverage, 3. Descriptive Naming, 4. Cross-Referencing Other Skills, 4. Token Efficiency (Critical), Antigravity Search Optimization (CSO), code:yaml (# ❌ BAD: Summarizes workflow - Antigravity may follow this i), code:yaml (# ❌ BAD: Too abstract, vague, doesn't include when to use) (+4 more)
...
Cohesion: 0.18
Nodes (11): 2. DIP - Dependency Inversion Principle, code:csharp (public interface ITownRepository), code:csharp (public sealed class LocalTownRepository : ITownRepository), Không Cần Interface Cho, Kết Luận, Nhược Điểm/Rủi Ro, Nên Dùng Interface Cho, Quyết Định (+3 more)

### Community 82 - "Community 82"
Cohesion: 0.18
Nodes (11): 4. UniTask, code:csharp (public async UniTask SaveTownAsync(TownData data, Cancellati), code:csharp (public sealed class TownLoaderView : MonoBehaviour), Không Dùng UniTask Cho, Kết Luận, Nhược Điểm/Rủi Ro, Nên Dùng UniTask Cho, Quyết Định (+3 more)
...
Cohesion: 0.17
Nodes (11): Automated Tests, code:csharp (using System.Collections.Generic;), CozyBuilder.Runtime, Kế hoạch thiết kế Hệ thống công cụ Debug 3D trực quan (Visual Debug Tooling System), Manual Verification, [MODIFY] [GameLifetimeScope.cs](file:///c:/1.SOURCE/Unity/Source/Cozy_Builder/Cozy_Builder/Assets/CozyBuilder/Runtime/Bootstrap/GameLifetimeScope.cs), [MODIFY] [PrototypeTownDebugView.cs](file:///c:/1.SOURCE/Unity/Source/Cozy_Builder/Cozy_Builder/Assets/CozyBuilder/Runtime/Town/Debugging/PrototypeTownDebugView.cs), [NEW] [PrototypeTownDebug3D.cs](file:///c:/1.SOURCE/Unity/Source/Cozy_Builder/Cozy_Builder/Assets/CozyBuilder/Runtime/Town/Debugging/PrototypeTownDebug3D.cs) (+3 more)

### Community 85 - "Community 85"
Cohesion: 0.18
Nodes (11): dependencies, depth, source, url, version, com.unity.nuget.newtonsoft-json, io.realvirtual.mcp, dependencies (+3 more)

### Community 86 - "Community 86"
Cohesion: 0.20
Nodes (9): After the Design, Anti-Pattern: "This Is Too Simple To Need A Design", Brainstorming Ideas Into Designs, Checklist, code:dot (digraph brainstorming {), Key Principles, Overview, Process Flow (+1 more)

### Community 87 - "Community 87"
Cohesion: 0.20
Nodes (10): 3. Struct Cho Data, code:csharp ([StructLayout(LayoutKind.Sequential)]), Không Dùng Struct Cho, Kết Luận, Mục Tiêu, Nhược Điểm/Rủi Ro, Quyết Định, Rule Bắt Buộc Khi Dùng Struct (+2 more)

### Community 88 - "Community 88"
Cohesion: 0.20
Nodes (9): Architecture And Code Rules, Asset Loading Flow, Checklist Bắt Buộc Khi Review Code, Kết Luận, Mục Đích, Placement Flow, Quy Tắc Kết Hợp 4 Thành Phần, Rule Tổng Quát (+1 more)

### Community 89 - "Community 89"
Cohesion: 0.20
Nodes (9): Bảng Theo Dõi Tiến Độ (Task Tracker), code:csharp (using UnityEngine;), code:csharp (private void HandleTouch()), code:csharp ([Header("Tap Constraints")]), Premium Camera Interactions & Mobile Touch Gestures Implementation Plan, Task 1: Nâng cấp `CameraService.cs` ( SmoothDamp & Bounding), Task 2: Cập nhật `PrototypeCameraInputDriver.cs` (Cử chỉ cảm ứng đa điểm & Zero GC), Task 3: Nâng cấp `PrototypePlacementInputDriver.cs` (Nhận diện Tap & Double-Tap Focus) (+1 more)
...
Cohesion: 0.22
Nodes (8): code:dot (digraph skill_flow {), How to Access Skills, Red Flags, Skill Priority, Skill Types, The Rule, User Instructions, Using Skills
...
Cohesion: 0.25
Nodes (7): Core Rules, Project Rule Priority, Single-Flow Execution Model, Skill Loading, Superpowers for Antigravity, Tool Translation Contract, Verification Discipline
...
Cohesion: 0.25
Nodes (8): As Interface, code:csharp (public sealed class GameLifetimeScope : LifetimeScope), code:csharp (builder.Register<PlacementService>(Lifetime.Singleton);), code:csharp (builder.Register<LocalTownRepository>(Lifetime.Singleton)), Khái Niệm Chính, Lifetime, LifetimeScope, Register
...
Cohesion: 0.87
Nodes (5): check-antigravity-profile.sh script, fail(), pass(), require_absent(), require_file()

### Community 103 - "Community 103"
Cohesion: 0.40
Nodes (4): GridCoord, CozyBuilder.Town.Data, GridNeighborhood, GridCoord

### Community 104 - "Community 104"
Cohesion: 0.40
Nodes (4): int, CozyBuilder.Town.Data, TownDataStore, int

### Community 105 - "Community 105"
Cohesion: 0.24
Nodes (8): GameObject, List, GameObject, List, AutoWirePrefabs(), CellVisualState, CozyBuilder.Town.Rendering, OnValidate()

### Community 106 - "Community 106"
Cohesion: 0.33
Nodes (6): dependencies, depth, hash, source, version, com.cysharp.unitask
...
Cohesion: 0.11
Nodes (17): 1. Tổng Quan Kiến Trúc (Architecture Overview), 2.1. Vẽ lưới Grid Line Mesh (1 Draw Call, 0 GC Alloc), 2.2. Focus-based 3D Floating UI (TextMesh), 2.3. Dirty Cell Highlight Pool (10 Box Markers), 2. Các Tính Năng & Cơ Chế Hoạt Động (Key Features), 3.1. Thiết lập trong Unity Editor Scene, 3.2. Sử dụng trên Giao diện Game (IMGUI Control), 3. Hướng Dẫn Sử Dụng (How to Use) (+9 more)
...
Cohesion: 0.40
Nodes (4): mcpServers, realvirtual-UnityMCP, args, command
...
Cohesion: 0.33
Nodes (4): MonoBehaviour, Renderer, BlockColorAdapter, CozyBuilder.Town.Rendering
...
Cohesion: 0.25
Nodes (8): [Analysis Title], Build evaluations first, code:json ({), Develop Skills iteratively with Antigravity, Evaluation and iteration, Executive summary, Key findings, Observe how Antigravity navigates Skills
...
Cohesion: 0.22
Nodes (5): CozyBuilder.Camera, UnityCamera, UnityCamera, CozyBuilder.Town.Placement, UnityCamera

### Community 135 - "Community 135"
Cohesion: 0.50
Nodes (4): code:csharp (public struct CellData), code:csharp ([Flags]), code:csharp (public readonly struct GridCoord : IEquatable<GridCoord>), Nên Dùng Struct Cho
...
Cohesion: 0.40
Nodes (4): Bảng Theo Dõi Tiến Độ (Task Tracker) - Hệ Thống Công Cụ Debug 3D Trực Quan (Visual Debug Tooling System), Bảng Theo Dõi Tiến Độ (Task Tracker) - Khắc Phục Chồng Chéo (Overlapping Blocks Fix), Bảng Theo Dõi Tiến Độ (Task Tracker) - Tích Hợp Màu Sắc & Chất Liệu Trực Quan (Color & Material Integration), Bảng Theo Dõi Tiến Độ (Task Tracker) - Tương Tác Camera Cao Cấp & Cử Chỉ Di Động
